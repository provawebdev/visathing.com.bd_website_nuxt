      ...
      <div class="container">
        ...
        <div class="row g-3">
          ...
          <!--<div class="col-lg-4 col-md-6">
                <div class="media-library-item card news-items">
                    <img alt="..." class="card-img-top" src="~/assets/img/news-2.png">
                    <div class="item-content">
                        <div class="news-item-header">
                            <p>
                                <svg fill="none" height="13" viewBox="0 0 10 13" width="10"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="news-item-body">
                            <h3 class="news-item-title">Travel Restrictions Between the
                                United States, Canada, and Mexico</h3>
                            <p class="news-item-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet
                                eu
                                enim,
                                purus, egest as. Iaculis a ut diam fames tristique</p>
                        </div>
                        <div class="news-item-footer d-flex justify-content-between">
                            <a class="news-item-link" href="/blog-details.html">Read More</a>
                            <a class="news-item-link" href="#">
                                <svg fill="none" height="15" viewBox="0 0 16 15"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="media-library-item card news-items">
                    <img alt="..." class="card-img-top" src="~/assets/img/news-3.png">
                    <div class="item-content">
                        <div class="news-item-header">
                            <p>
                                <svg fill="none" height="13" viewBox="0 0 10 13" width="10"
                        ...
                        <div class="news-item-body">
                            <h3 class="news-item-title">Everything You Need to Know About Travel Bubbles</h3>
                            <p class="news-item-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet
                                eu
                                enim,
                                purus, egest as. Iaculis a ut diam fames tristique</p>
            ...
            <div class="col-lg-4 col-md-6 d-lg-none">
                <div class="media-library-item card news-items">
                    <img alt="..." class="card-img-top" src="~/assets/img/news-1.png">
                    <div class="item-content">
                        <div class="news-item-header">
                            <p>
                                <svg fill="none" height="13" viewBox="0 0 10 13" width="10"
                        ...
                        <div class="news-item-body">
                            <h3 class="news-item-title">How Do You Renew an Expired Passport?</h3>
                            <p class="news-item-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet
                                eu
                                enim,
                                purus, egest as. Iaculis a ut diam fames tristique</p>
